...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = 'v3mipwrqrskDiL70relaYXrIX'
        consumer_secret = 'y6FGcL8UyA6ofcJ79avYs4RK4WNqbqelDm1WvGoJaoFvgQNC4C'
        access_token = '586737504-Y4juBYCViLi2P9PN6ciaahIcII7yPg0C8UDEAyEJ'
        access_token_secret = 'kIgpNzkzmMeYj6QzYH5Sm7fESdOsdGBxkxvZf8UmAro1e'
